...
class MutationTestExecutor {
    ...
    executeCheck(input$) {
        ...
        const checkResult$ = failedCheckResult$.pipe(operators_1.map((failedMutant) => this.mutationTestReportHelper.reportCheckFailed(failedMutant.mutant.mutant, failedMutant.checkResult)));
