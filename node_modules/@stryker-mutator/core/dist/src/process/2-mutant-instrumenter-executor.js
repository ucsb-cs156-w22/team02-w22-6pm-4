...
class MutantInstrumenterExecutor {
    ...
    async execute() {
        ...
        const instrumentResult = await instrumenter.instrument(this.inputFiles.filesToMutate, Object.assign(Object.assign({}, this.options.mutator), { mutationRanges: this.inputFiles.mutationRanges }));
