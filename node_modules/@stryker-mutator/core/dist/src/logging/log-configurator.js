...
class LogConfigurator {
    ...
    static configureMainProcess(consoleLogLevel = "info" /* Information */, fileLogLevel = "off" /* Off */, allowConsoleColors = true) {
        ...
        log4js_1.default.configure(this.createLog4jsConfig(log_utils_1.minLevel(consoleLogLevel, fileLogLevel), appenders));
    }
    /**
    ...
    static async configureLoggingServer(consoleLogLevel, fileLogLevel, allowConsoleColors) {
        const loggerPort = await net_utils_1.getFreePort();
        ...
        const defaultLogLevel = log_utils_1.minLevel(consoleLogLevel, fileLogLevel);
