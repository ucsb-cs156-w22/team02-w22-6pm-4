...
class StrykerConfigWriter {
    ...
    async writePreset(presetConfig, exportAsJson) {
        const config = Object.assign({ _comment: `This config was generated using 'stryker init'. Please see the guide for more information: ${presetConfig.guideUrl}` }, presetConfig.config);
