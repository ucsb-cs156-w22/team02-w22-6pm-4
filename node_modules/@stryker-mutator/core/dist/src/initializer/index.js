...
const initializerTokens = tslib_1.__importStar(require("./initializer-tokens"));
...
function initializerFactory() {
    return di_1.provideLogger(typed_inject_1.createInjector())
        ...
        .provideValue(initializerTokens.strykerPresets, stryker_presets_1.strykerPresets)
        ...
        .provideClass(initializerTokens.npmClient, npm_client_1.NpmClient)
        .provideClass(initializerTokens.configWriter, stryker_config_writer_1.StrykerConfigWriter)
        .provideClass(initializerTokens.gitignoreWriter, gitignore_writer_1.GitignoreWriter)
        .provideClass(initializerTokens.inquirer, stryker_inquirer_1.StrykerInquirer)
        .injectClass(stryker_initializer_1.StrykerInitializer);
}
