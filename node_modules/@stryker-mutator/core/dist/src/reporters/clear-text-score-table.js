...
class ClearTextScoreTable {
    ...
    drawValues(current = this.metricsResult, ancestorCount = 0) {
        return [this.drawRow((c) => c.drawTableCell(current, ancestorCount))].concat(lodash_flatmap_1.default(current.childResults, (child) => this.drawValues(child, ancestorCount + 1)));
    }
    /**
