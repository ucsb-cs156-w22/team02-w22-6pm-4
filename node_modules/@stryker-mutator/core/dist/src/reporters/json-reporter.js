...
const ReporterUtil = tslib_1.__importStar(require("./reporter-util"));
...
class JsonReporter {
    ...
    async generateReport(report) {
        ...
        this.log.info(`Your report can be found at: ${file_url_1.default(filePath)}`);
    }
}
exports.JsonReporter = JsonReporter;
JsonReporter.inject = plugin_1.tokens(plugin_1.commonTokens.options, plugin_1.commonTokens.logger);
