...
function dashboardReporterFactory(injector) {
    return injector
        ...
        .provideClass(tokens_1.dashboardReporterTokens.dashboardReporterClient, dashboard_reporter_client_1.DashboardReporterClient)
        .provideFactory(tokens_1.dashboardReporterTokens.ciProvider, provider_1.determineCIProvider)
        .injectClass(dashboard_reporter_1.DashboardReporter);
}
