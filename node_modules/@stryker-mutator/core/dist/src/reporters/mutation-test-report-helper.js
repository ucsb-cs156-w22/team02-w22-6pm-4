    ...
    toStatus(status) {
        switch (status) {
            case report_1.MutantStatus.Killed:
                return report_1.mutationTestReportSchema.MutantStatus.Killed;
            case report_1.MutantStatus.NoCoverage:
                return report_1.mutationTestReportSchema.MutantStatus.NoCoverage;
            case report_1.MutantStatus.RuntimeError:
                return report_1.mutationTestReportSchema.MutantStatus.RuntimeError;
            case report_1.MutantStatus.Survived:
                return report_1.mutationTestReportSchema.MutantStatus.Survived;
            case report_1.MutantStatus.TimedOut:
                return report_1.mutationTestReportSchema.MutantStatus.Timeout;
            case report_1.MutantStatus.CompileError:
                return report_1.mutationTestReportSchema.MutantStatus.CompileError;
            case report_1.MutantStatus.Ignored:
                return report_1.mutationTestReportSchema.MutantStatus.Ignored;
            default:
