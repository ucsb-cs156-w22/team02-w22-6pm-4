...
export declare const MUTANT_PLACERS: readonly MutantPlacer[];
/**
 ...
 */
export declare function placeMutants(node: NodePath, mutants: Mutant[], fileName: string, mutantPlacers?: readonly MutantPlacer[]): boolean;
